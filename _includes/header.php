...
<html>
	<head>
		...
		<!-- <script src="http://localhost:8888/_assets/js/main.min.js"></script> -->
	...
	<body class="gridlock">
		<div class="row">
			<nav class="max-3 desktop-3 tablet-2 mobile-3 min-3">
				<ul>
			...
			<section class="max-9 desktop-9 tablet-4 mobile-3 min-3">
				<div class="content">